...
Classical trajectory forecasting often starts from constant-position, constant-velocity, or constant-acceleration assumptions, then augments them with learned dynamics or scene context. Our baseline follows this tradition by filtering the observed history and rolling forward without future measurements.
...
\todo{Replace these paragraphs with cited related work once target workshop and bibliography are fixed.}
